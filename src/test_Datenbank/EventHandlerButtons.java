	...
	public void actionPerformed(ActionEvent e){
		if(e.getSource()==testgui.getkSende()){
			...
			try{
				...
				throw new RuntimeException("Einfügen nicht möglich!");
			}
		}
			...
			try{
				...
				throw new RuntimeException("Löschen nicht möglich!");
			...
			catch(Exception ex){throw new RuntimeException("Ändern nicht möglich!"+ex);
			}
		}
